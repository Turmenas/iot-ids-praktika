...
\end{tabularx}
\vspace{2pt}
\raggedright\scriptsize Rodikliai išmatuoti \textbf{testavimo} aibėje ties argmax, o ne ties klaidingų teigiamų biudžetu, todėl su pagrindine aptikimo kokybės lentele tiesiogiai negretinami. $n$ žymi tikrų pavyzdžių skaičių; retose kategorijose vienas kitoks sprendimas keičia atkūrimą per dešimtąsias procentinio punkto dalis.
\endgroup
