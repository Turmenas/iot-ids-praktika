...
\end{tabularx}
\vspace{2pt}
\raggedright\scriptsize testavimo aibė, argmax. Pirmasis stulpelis rodo klaidingai suklasifikuotų eilučių dalį, o kiti trys rodo tų klaidų pasiskirstymą. \textbf{Tarp atakų} reiškia, kad pavojaus signalas įvyko, o suklysta tik kategorija; eksploatacijai tai pigiausia klaidos rūšis, nors bendras tikslumas ją skaičiuoja taip pat kaip praleistą ataką.
\endgroup
