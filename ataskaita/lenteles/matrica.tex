...
\begin{tabularx}{\textwidth}{@{}>{\raggedright\arraybackslash}X>{\centering\arraybackslash}p{1.15cm}>{\centering\arraybackslash}p{1.35cm}>{\centering\arraybackslash}p{1.15cm}>{\centering\arraybackslash}p{1.45cm}>{\centering\arraybackslash}p{1.25cm}>{\raggedright\arraybackslash}p{1.9cm}@{}}
\toprule
\textbf{Metodas} & \textbf{Kokybė} & \textbf{Disba\-lansas} & \textbf{Resur\-sai} & \textbf{Interpre\-tuojamumas} & \textbf{Svertinė suma} & \textbf{Šalt.} \\
