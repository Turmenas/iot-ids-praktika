...
\end{tabularx}
\vspace{2pt}
\raggedright\scriptsize Testavimo aibė. Klausiama tik to, ar eilutė pažymima kaip \emph{bet kuri} ataka: pašalinus \texttt{DICTIONARYBRUTEFORCE} ištuštėja visa \texttt{BruteForce} kategorija, todėl macro-F1 su baziniu modeliu būtų nepalyginamas. Autokoderis \emph{nepermokomas} --- jis mokomas tik iš gerybinio srauto, tad visos atakų klasės jam ir taip nematytos. Paskutinis stulpelis rodo, kiek kainuoja klasės nematyti. Kiekvienam modeliui $\tau$ parinktas validacijos aibėje.
\endgroup
