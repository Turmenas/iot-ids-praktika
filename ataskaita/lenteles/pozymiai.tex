...
\end{tabularx}
\vspace{2pt}
\raggedright\scriptsize Vidutinis informacijos prieaugis (gain), normalizuotas iki visų 36 naudotų požymių sumos; XGBoost, aštuonių kategorijų formuluotė, pradinis dydis 42. Skaičiuojama iš paties modelio, o duomenų aibė neatidaroma. Penki pirmieji požymiai surenka 80,4~\%, o visi dešimt surenka 86,2~\% viso prieaugio. Šeši sąmoningai palikti mažos dispersijos požymiai kartu surenka 1,9~\%. Gain nerodo krypties. Jis pasako, kuo modelis remiasi, o ne kokia požymio reikšmė reiškia ataką.
\endgroup
