...
\end{tabularx}
\vspace{2pt}
\raggedright\scriptsize Testavimo aibė, suderintos konfigūracijos, vidurkis iš 3 paleidimų. Slenkstis $\tau$ kiekvienam modeliui parinktas validacijos aibėje. \textsuperscript{a}~Dviejų blokų reikšmės tarpusavyje nepalyginamos, nes prižiūrimi modeliai sprendžia aštuonių kategorijų uždavinį, o autokoderis dvejetainį, todėl jam didžiausios tikimybės taškas neapibrėžtas. \textsuperscript{b}~Peržengia 1~\% biudžetą (žr. \ref{sec:patikimumas} poskyrį). Autokoderio PR-AUC yra 0,996, t.~y. rikiavimas geras, nors sprendimas ties reikalaujamu biudžetu nepakankamas.
\endgroup
